...
from ..omx_follower.config_omx_follower import OmxFollowerConfig
...
class BiOmxFollower(Robot):
    """
    Bimanual [OMX](https://github.com/ROBOTIS-GIT/open_manipulator) follower robot,
    composed of two OmxFollower arms controlled as a single robot.
    """
